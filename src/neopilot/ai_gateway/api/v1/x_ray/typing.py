...
from neopilot.ai_gateway.models import KindAnthropicModel, KindModelProvider
...
class XRayRequest(BaseModel):
    prompt_components: Annotated[List[PackageFilePromptComponent], Field(min_length=1, max_length=1)]

...
class EventMergeRequestPayload(EventRequestPayload):
    ...
    comment_start_line: Optional[Annotated[str, StringConstraints(max_length=1024)]] = None
    comment_end_line: Optional[Annotated[str, StringConstraints(max_length=1024)]] = None
...
class EventRequest(BaseModel):
    ...
    event_id: Optional[Annotated[str, StringConstraints(max_length=255)]] = "Quick Action"
    payload: Union[EventMergeRequestPayload, EventIssuePayload, EventHookPayload] = Field(discriminator="source")

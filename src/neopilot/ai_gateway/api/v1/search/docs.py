...
def log_search_results(custom_models_enabled, search_params, response, results, token_count=None):
...
@router.post("/gitlab-docs", response_model=SearchResponse, status_code=status.HTTP_200_OK)
...
async def docs(
    ...
    log_search_results(custom_models_enabled, search_params, response, results, token_count)

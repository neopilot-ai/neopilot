...
def feature_categories(mapping: dict[GitLabUnitPrimitive, GitLabFeatureCategory]):
    ...
    def decorator(func: typing.Callable) -> typing.Callable:
        @functools.wraps(func)
        async def wrapper(request: Request, *args: typing.Any, **kwargs: typing.Any) -> typing.Any:
            try:
    ...
    def decorator(func: typing.Callable) -> typing.Callable:
        ...
        async def wrapper(request: Request, *args: typing.Any, **kwargs: typing.Any) -> typing.Any:
            ...
            if request_param_val in mapping:
                ...
                gitlab_feature_category = FEATURE_CATEGORIES_FOR_PROXY_ENDPOINTS[unit_primitive]
...
def current_feature_category() -> str:
    ...
    if context.exists():
        gitlab_feature_category = context.get(_CATEGORY_CONTEXT_KEY, _UNKNOWN_FEATURE_CATEGORY)

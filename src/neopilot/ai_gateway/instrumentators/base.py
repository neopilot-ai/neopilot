...
class TextGenModelInstrumentator:
    ...
    class WatchContainer:
        ...
        def register_model_exception(self, message: str, status_code: Optional[int] = None):
        ...
        def register_model_output_length(self, model_output: str):
            self.__dict__.update(
                {
                    "model_output_length": self.__dict__.get("model_output_length", 0) + len(model_output),
                    "model_output_length_stripped": self.__dict__.get("model_output_length_stripped", 0)
        ...
        def register_safety_attributes(self, safety_attributes: SafetyAttributes):
            ...
            if safety_attributes.categories:
                self.__dict__.update({"safety_categories": safety_attributes.categories})
    ...
    def watch(self, prompt, **kwargs: Any):
        ...
        try:
            ...
            self._track_model_cost("output", container_dict.get("model_output_length_stripped", 0))

...
from neopilot.ai_gateway.code_suggestions.processing.pre.base import PromptBuilderBase
...
class PromptBuilderPrefixBased(PromptBuilderBase):
    ...
    def build(self) -> Prompt:
        ...
        max_length_code_context = math.floor(min(max_length_code_context, max_length * context_max_percent))
    ...
    def _build_prefix(self, max_length: int) -> CodeContent:
        ...
        for code in self.snippets:
            ...
            truncated = self.tkn_strategy.truncate_content(code, length, truncation_side="left")
    ...
    def _build_suffix(self, max_length: int) -> Optional[CodeContent]:
        ...
        truncated = self.tkn_strategy.truncate_content(self.suffix, max_length, truncation_side="right")

        return truncated

    def _build_code_context(self, max_length: int) -> Optional[tuple[CodeContent, CodeContent]]:
        ...
        truncated = self.tkn_strategy.truncate_content(original.text, max_length, truncation_side="right")

...
from neopilot.ai_gateway.code_suggestions.prompts.parsers.mixins import RubyParserMixin
...
class FunctionSignatureVisitorFactory:
    ...
    def from_language_id(lang_id: LanguageId) -> Optional[BaseFunctionSignatureVisitor]:
        if klass := FunctionSignatureVisitorFactory._LANG_ID_VISITORS.get(lang_id, None):
            return klass()

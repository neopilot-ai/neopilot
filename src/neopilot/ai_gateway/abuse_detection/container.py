...
from neopilot.ai_gateway.abuse_detection.detector import AbuseDetector
...
class ContainerAbuseDetection(containers.DeclarativeContainer):
    ...
    abuse_detector = providers.Singleton(
        ...
        model=providers.Factory(models.anthropic_claude_chat, KindAnthropicModel.CLAUDE_3_HAIKU),
    )

...
class FeatureFlag(StrEnum):
    ...
    STREAM_DURING_TOOL_CALL_GENERATION = "duo_workflow_stream_during_tool_call_generation"
...
current_feature_flag_context: ContextVar[Set[str]] = ContextVar("current_feature_flag_context", default=set())
